...
\begin{enumerate}
    \item[a)] Prove that no matter the choice of $p$, the number $n$ is always at least $4$.
    \item[b)] Find the actual minimal value $m$ that $n$ can reach among all possible choices for $p$.
    That is:
    \begin{itemize}
